package com.steven.curso.springboot.app.interceptor.springboot_interceptor.controllers;
...
public class FooController {
    ...
    @GetMapping("/tri")
    public Map<String, String> tri() {

        return Collections.singletonMap("message", "handler tri del controlador");
    }
